...
<div id="content">
	<p id="tombol-tambah-container"><a href="index.php?p=buku-input" class="tombol">Tambah Data</a>
	<a target="_blank" href="pages/cetak_buku.php">
            <img src="images/print.png" height="25px" width="25px"></a>
            <a target="_blank" href="pdf_buku.php"><img src="images/pdf.jpg" height="25px" width="25px"></a>
            <FORM class="form-inline" method="Post">
                <div align="right">
                    <form method="POST">
                        <input type="text" name = "pencarian">
                        <input type="submit" name="seacrh" value="search" class="tombol" >
                    </form>
                </div>	
            </FORM>
	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				...
				<div class="tombol-opsi-container"><a href="proses/buku-hapus.php?id=<?php echo $r_tampil_buku['idbuku']; ?>" onclick="return confirm('Apakah anda yakin?')" class="tombol">Hapus</a></div>
			</td>
		</tr>
		<?php $nomor++; }
            }
