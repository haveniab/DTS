...
<div id="content">
    <p id="tombol-tambah-container">
        ...
        <a target="_blank" href="pages/cetak_anggota.php"><img src="images/print.png" height="25px" width="25px"></a>
        <a target="_blank" href="pdf_anggota.php"><img src="images/pdf.jpg" height="25px" width="25px"></a>
            ...
            <tr>
                ...
                <td>
                    <div class="tombol-opsi-container">
                        <a target="_blank" href="pages/cetak_kartuAnggota.php?id=<?php echo $r_tampil_anggota['idanggota']; ?>"  
                    ...
                    <div class="tombol-opsi-container">
                        ...
                        onclick="return confirm('Apakah anda yakin?')" class="tombol">Hapus</a></div>
                </td>
            </tr>
            <?php $nomor++; }
            }
